...
$coolstuff_page_layouts = apply_filters( 'coolstuff_fnc_get_page_sidebar_configs', null );

get_header( apply_filters( 'coolstuff_fnc_get_header_layout', null ) );
?>
<?php do_action( 'coolstuff_template_main_before' ); ?>
<section id="main-container" class="<?php echo apply_filters('coolstuff_template_main_container_class','container-full');?> inner">
	<div class="row">
