...
?>
<section class="widget  widget-style frontpage-2 frontpage-posts section-blog layout-<?php echo esc_attr($layout); ?>  <?php echo (($el_class!='')?' '.$el_class:''); ?>">
    <?php
        if($title!=''){ ?>
...
<?php
 ...
 ?>
        <?php if( $i<=$main-1) { ?>
            ...
            <?php } ?>
             <?php get_template_part( 'vc_templates/post/_single-fp-v1' ) ?>
