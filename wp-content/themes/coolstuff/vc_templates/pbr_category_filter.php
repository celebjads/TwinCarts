 ...
 ?>
    <div class="widget <?php echo (($el_class!='')?' '.esc_attr( $el_class ):''); ?>">
        <div class="widget-content nopadding">
            <?php if($style ==  'style1') { ?>
                <div class=" pbr-category-filter category-filter-v1">
                    <div class="category-filter-content">
                        <h4 class="category-filter-title">
                                <span><?php echo trim($term->name); ?></span>
                        </h4>
                         <small><?php echo trim($term->count); ?> <?php esc_html_e( 'Products', 'coolstuff' );?></small>  
                        ...
                        <div class="category-filter-link">
                            <a href="<?php echo esc_url( $category_link ); ?>" title="<?php esc_html_e( 'shop now', 'coolstuff'); ?>" class="btn btn-light"><?php esc_html_e( 'shop now', 'coolstuff' ); ?></a>
                        </div>
                    </div>
            ...
            <?php } else { ?>
                <div class="pbr-category-filter category-filter-default">
                    <?php if( $image ) { ?>
                        <img src="<?php echo esc_url_raw( $image[0] ); ?>" title="<?php echo esc_attr($term->name); ?>" style="max-width: 100%" alt="">
                    <?php } ?>
                    <div class="category-caption">
                        <h4 class="text-none text-white category__title">
                            <span><?php echo trim($term->name); ?></span>
                        </h4>
                        <small class="text-white category_item__count"><?php echo trim($term->count); ?> <?php esc_html_e( 'Products', 'coolstuff' );?></small>  
