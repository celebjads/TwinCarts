...
<section class="widget  widget-style frontpage-blog section-blog layout-<?php echo esc_attr($layout); ?>  <?php echo (($el_class!='')?' '.$el_class:''); ?>">
    <?php
        if($title!=''){ ?>
...
<div class="row">
                <?php
                 ...
                 ?>
                        <?php if( $i<=$main-1) { ?>
                            <?php if( $i == 0 ) {  ?>
                                <div  class="col-sm-12 col-md-6 main-blog large">
                            <?php } ?>
                        ...
                        <?php } else { ?>
                                <?php if( $i == $main  ) { ?>
                                <div class="col-sm-12 col-md-6 secondary-blog">
                                     <div class="row">
                                <?php }  ?>
