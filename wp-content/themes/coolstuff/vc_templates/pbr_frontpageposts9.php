...
<section class="widget  widget-style  frontpage-posts frontpage-9 layout-<?php echo esc_attr($layout); ?>  <?php echo (($el_class!='')?' '.$el_class:''); ?>">
    <?php
        if($title!=''){ ?>
                    ...
                    <article class="post">
                        ...
                        if ( has_post_thumbnail() ) {
                            ?>
                                <figure class="entry-thumb">
                                    ...
                                    <!-- vote    -->
                                    <?php do_action('coolstuff_fnc_rating') ?>
                                </figure>
                            <?php
                        }
                        ?>
                        <div class="entry-content">
                            ...
                            <div class="entry-meta">
                                ...
                                <span class="entry-comments"><?php comments_number('0', '1', '%'); ?></span>                                
                            </div>
