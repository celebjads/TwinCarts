...
if( class_exists("WPBakeryShortCode") ){
	...
	class WPBakeryShortCode_PBR_Tabs_Products extends WPBakeryShortCode {
		...
		public function getTabTitle($type){ 
			switch ($type) {
				case 'recent':
					return array('title'=>esc_html__('Latest Products', 'coolstuff' ),'title_tab'=>esc_html__('Latest', 'coolstuff' ));
				case 'featured_product':
					return array('title'=>esc_html__('Featured Products', 'coolstuff' ),'title_tab'=>esc_html__('Featured', 'coolstuff' ));
				case 'top_rate':
					return array('title'=> esc_html__('Top Rated Products', 'coolstuff' ),'title_tab'=>esc_html__('Top Rated', 'coolstuff'));
				case 'best_selling':
					return array('title'=>esc_html__('BestSeller Products', 'coolstuff' ),'title_tab'=>esc_html__('BestSeller', 'coolstuff' ));
				case 'on_sale':
					return array('title'=>esc_html__('Special Products', 'coolstuff' ),'title_tab'=>esc_html__('Special', 'coolstuff' ));
			}
		}
	}
	...
	class WPBakeryShortCode_pbr_frontproducts extends WPBakeryShortCode {}
	class WPBakeryShortCode_pbr_frontcategoryproducts extends WPBakeryShortCode {}
 }
