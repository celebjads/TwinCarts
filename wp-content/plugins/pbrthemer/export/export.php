...
class PbrThemer_Export {
	...
	public function pbrthemer_admin_export() {
		...
		add_submenu_page( 'themes.php', __( 'WpOpal Export', 'pbrthemer' ), esc_html__( 'WpOpal Export', 'pbrthemer' ), 'manage_options', 'pbrthemer_options_export_page', array(
			&$this,
		...
		<div class="wrapper">
			<div class="content">
				<table class="form-table">
					<tbody>
					<tr>
						<td scope="row" width="150"><h2><?php esc_html_e( 'Export Wordpress Content', 'pbrthemer' ); ?></h2></td>
					</tr>
					...
					<tr>
						<td scope="row" width="150"><h2><?php esc_html_e( 'Export Revolution Slider', 'pbrthemer' ); ?></h2></td>
					</tr>

					<tr>
						<td scope="row" width="150">
							<?php _e( 'Please access Revolution Slider and use export tools to get package then put inside THEME/inc/import/THEMENAME' ) ;?>
						</td>
					</tr>
