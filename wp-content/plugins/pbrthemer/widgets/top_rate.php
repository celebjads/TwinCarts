...
if(class_exists('PostRatings')){
    ...
    class Pbr_Themer_Top_Rate_Widget extends Pbr_Themer_Widget {
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>"><?php _e('Get most rated:', PostRatings::ID); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('sort')); ?>"><?php _e('Sort by:', PostRatings::ID); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('date_limit')); ?>"><?php _e('Ignore posts older than:', PostRatings::ID); ?></label>
                <input id="<?php echo esc_attr($this->get_field_id('date_limit')); ?>" name="<?php echo esc_attr($this->get_field_name('date_limit')); ?>" type="text" value="<?php echo esc_attr( $instance['date_limit'] ); ?>" size="3" /> <?php _e('days', PostRatings::ID); ?>
                <br />
                <small><?php _e('(0 to ignore date)', PostRatings::ID); ?></small>
            </p>

            <p>
                <label for="<?php echo esc_attr($this->get_field_id('number')); ?>"><?php _e('Limit:', PostRatings::ID); ?></label>
